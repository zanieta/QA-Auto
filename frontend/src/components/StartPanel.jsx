...
export default function StartPanel({ defaultCycle, onSelectCycle }) {
    ...
    <div className="start-panel-wrap">
      <div className="start-panel">
        ...
        <p className="start-panel-hint">
          ...
          <span className="mono">TC-2075</span>) — or paste a cycle id or key below.
        </p>
        ...
        {defaultCycle && (
          ...
          >
            Continue with <span className="mono">{defaultCycle}</span>
          </button>
        )}
      </div>
    </div>
